...
Welcome to `python-debugtoolkit` contributor's guide.
...
If you experience bugs or general issues with `python-debugtoolkit`, please have a look
...
You can help improve `python-debugtoolkit` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`python-debugtoolkit` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `python-debugtoolkit`'s files. While this mechanism can
...
```
conda create -n python-debugtoolkit python=3 six virtualenv pytest pytest-cov
conda activate python-debugtoolkit
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/python-debugtoolkit.git
   cd python-debugtoolkit
   ```
...
5. Install [pre-commit]:
   ...
   `python-debugtoolkit` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/andrijdavid/python-debugtoolkit
[issue tracker]: https://github.com/andrijdavid/python-debugtoolkit/issues
